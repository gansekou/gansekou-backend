...
class Quiz(Base):
    ...
    #
    # Le système officiel utilise maintenant quiz_levels.
    # Cette colonne sera supprimée dans une migration ultérieure
    # lorsque tout le projet aura été migré.
    ...
    # Nouvelle relation : 1 ou plusieurs niveaux
