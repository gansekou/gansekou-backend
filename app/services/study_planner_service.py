...
def generate_study_plan(
    ...
    plan = StudyPlan(
        ...
        description=(
            "Plan généré automatiquement selon vos faiblesses, "
            "vos quiz et votre progression."
        ),
        language=language,
    ...
    weaknesses = (
        ...
        .filter(
            ...
            StudentSkillProgress.status.in_(
                ["WEAK", "IN_PROGRESS"]
            ),
        )
        .order_by(
    ...
    for weakness in weaknesses:
        ...
        # ========================================================
        #
        # Un contenu peut maintenant être associé à plusieurs
        # niveaux via content_levels.
        #
        # On recherche donc le contenu correspondant au niveau
        # précis de la faiblesse.
        # ========================================================
        ...
        content = (
            ...
            .filter(
                ...
                ContentLevel.level_id == weakness.level_id,
        ...
        # ========================================================
        #
        # Un quiz peut maintenant être associé à plusieurs
        # niveaux via quiz_levels.
        #
        # On recherche donc un quiz qui contient le niveau
        # de la faiblesse.
        # ========================================================
        ...
        quiz = (
            ...
            .join(
                QuizLevel,
                QuizLevel.quiz_id == Quiz.id,
            )
            .filter(
                Quiz.subject_id == weakness.subject_id,

                QuizLevel.level_id == weakness.level_id,
        ...
        item = StudyPlanItem(
            ...
            title=(
                f"Renforcer : "
                f"{weakness.skill_name}"
            ),

            description=(
                f"Votre maîtrise actuelle est de "
                f"{weakness.mastery_score}%. "
                f"Révisez cette compétence puis faites un quiz."
            ),
    ...
    if items_created == 0:
        ...
        general_item = StudyPlanItem(
            ...
            description=(
                ...
                "Commencez par un quiz pour générer "
...
def get_plan_items(
    ...
    return (
        ...
        .filter(
            StudyPlanItem.study_plan_id
            == plan_id
        )
        .order_by(
            StudyPlanItem.order_index.asc()
        )
        .all()
    )
